package com.example.oleg.androidacademymsk.data;
...
public class DataUtils {
    ...
    private static Calendar createDate(int year, int month, int date, int hrs, int min) {
        return new GregorianCalendar(year, month - 1, date, hrs, min);
    }
}